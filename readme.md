...
Notasi has been built to have the lowest possible barrier of entry. While scaling Notasi should be possible, it’s designed to help users solve problems quickly without knowing all the answers. Once you're annoyed with Notasi's limitations.. it's probably to to graduate to a proper enterprise data hub/lake.  
